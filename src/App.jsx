...
import { Volume2, VolumeX, ChevronDown, Github, Twitter, Tv } from 'lucide-react';
    ...
    <div className="app-container with-sidebar">
      ...
      <aside className="sidebar glass-panel">
        ...
        <nav className="sidebar-nav">
          <a href="#toki-pona" className="btn btn-glass">关于 panaolin.com</a>
          <a href="#projects" className="btn btn-glass">项目 Projects</a>
          <a href="#about" className="btn btn-glass">关于我 About Me</a>
        </nav>
      </aside>
